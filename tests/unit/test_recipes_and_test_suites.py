...
def test_nightly_compute_stays_below_4266_hours(nightly_test_suite, tracker):
    ...
    assert total_gpu_hours <= 4266, (
        f"Total GPU hours exceeded 4266: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
