...
def test_nightly_compute_stays_below_4024_hours(nightly_test_suite, tracker):
    ...
    # The managed Dynamo 3x8 H100 SWE1 test adds 96 GPU-hours to the former
    # 3928-hour limit.
    assert total_gpu_hours <= 4024, (
        f"Total GPU hours exceeded 4024: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
