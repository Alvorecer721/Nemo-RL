...
def main():
    ...
    # setup data (Apertus views+media omni preference adapter; everything else
    # in this file is byte-identical to examples/run_dpo.py)
    from transformers import AutoConfig

    from nemo_rl_apertus.omni_preference import build_processed_datasets

    dataset, val_dataset = build_processed_datasets(
        config["data"]["omni_dataset_root"],
        tokenizer,
