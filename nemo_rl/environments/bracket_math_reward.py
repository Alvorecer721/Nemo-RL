...
"""Marked-answer reward shared with the verl side of the Apertus RL framework benchmark.
...
def score_marked_answer(
    ...
    format_reward = FORMAT_REWARD if has_marker(response, marker) else 0.0
    outcome = (
        OUTCOME_REWARD
