...
AP_VARIANT=${AP_VARIANT:?set AP_VARIANT to 70b-bench[-tp4pp2|-tp1pp8|-fused|-mb8|-tis2|-l1t2|-sync|-lag1], 70b-smoke[-tp4pp2|-tp1pp8|-fused|-mb8] or 8b-smoke}
case "$AP_VARIANT" in
  70b-bench)
  ...
  70b-bench-tp1pp8)
    ...
    AP_TIME_DEFAULT=04:00:00 ;;
  70b-bench-fused)
    RECIPE_NAME=grpo-apertus1p5-70b-16n4g-megatron-tp2pp4-fused-sc-bench.yaml
    AP_CKPT_DEFAULT=/capstor/store/cscs/swissai/infra01/users/xyixuan/rl-bench/models/ap1p5-70b-sft-262k-2700_corr
    AP_EXPECTED_STEPS_DEFAULT=92
    AP_TIME_DEFAULT=04:00:00 ;;
  70b-smoke-fused)
    RECIPE_NAME=grpo-apertus1p5-70b-16n4g-megatron-tp2pp4-fused-sc-bench-smoke.yaml
    AP_CKPT_DEFAULT=/capstor/store/cscs/swissai/infra01/users/xyixuan/rl-bench/models/ap1p5-70b-sft-262k-2700_corr
  ...
  70b-bench-tis2)
    ...
    AP_TIME_DEFAULT=04:00:00 ;;
  70b-bench-l1t2)
    RECIPE_NAME=grpo-apertus1p5-70b-16n4g-megatron-tp2pp4-lag1-tis2-sc-bench.yaml
    AP_CKPT_DEFAULT=/capstor/store/cscs/swissai/infra01/users/xyixuan/rl-bench/models/ap1p5-70b-sft-262k-2700_corr
    AP_EXPECTED_STEPS_DEFAULT=92
    AP_TIME_DEFAULT=04:00:00 ;;
  70b-smoke-mb8)
    RECIPE_NAME=grpo-apertus1p5-70b-16n4g-megatron-tp2pp4-mb8-sc-bench-smoke.yaml
    AP_CKPT_DEFAULT=/capstor/store/cscs/swissai/infra01/users/xyixuan/rl-bench/models/ap1p5-70b-sft-262k-2700_corr
    AP_EXPECTED_STEPS_DEFAULT=2
    AP_TIME_DEFAULT=01:30:00 ;;
  70b-bench-sync)
    RECIPE_NAME=grpo-apertus1p5-70b-16n4g-megatron-tp2pp4-sc-bench-sync.yaml
    AP_CKPT_DEFAULT=/capstor/store/cscs/swissai/infra01/users/xyixuan/rl-bench/models/ap1p5-70b-sft-262k-2700_corr
    AP_EXPECTED_STEPS_DEFAULT=92
    AP_TIME_DEFAULT=04:00:00 ;;
  70b-bench-lag1)
    RECIPE_NAME=grpo-apertus1p5-70b-16n4g-megatron-tp2pp4-sc-bench-lag1.yaml
    AP_CKPT_DEFAULT=/capstor/store/cscs/swissai/infra01/users/xyixuan/rl-bench/models/ap1p5-70b-sft-262k-2700_corr
    AP_EXPECTED_STEPS_DEFAULT=92
    AP_TIME_DEFAULT=04:00:00 ;;
  70b-smoke)
