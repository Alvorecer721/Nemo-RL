...
GLM_RECIPE=${GLM_RECIPE:-$REPO_DIR/infra/slurm/cscs/autoresearch/recipes/grpo-glm5.1-136n4g-megatron-tp2pp18ep16-ready-first.yaml}
...
GLM_EXPECTED_MIN_GROUPS_FOR_STREAMING_TRAIN=${GLM_EXPECTED_MIN_GROUPS_FOR_STREAMING_TRAIN:-16}
GLM_EXPECTED_SPEC_TOKENS=${GLM_EXPECTED_SPEC_TOKENS:-0}
GLM_EXPECTED_SPEC_METHOD=${GLM_EXPECTED_SPEC_METHOD:-none}
GLM_EXPECTED_FUSED_LINEAR_LOGPROBS=${GLM_EXPECTED_FUSED_LINEAR_LOGPROBS:-0}
...
export GLM_EXPECTED_MIN_GROUPS_FOR_STREAMING_TRAIN
export GLM_EXPECTED_SPEC_TOKENS GLM_EXPECTED_SPEC_METHOD
export GLM_EXPECTED_FUSED_LINEAR_LOGPROBS
