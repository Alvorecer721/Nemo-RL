...
| Bridge merge | done, `3880d9e0`; Bridge/Core gate on the assembled image (job 3352054): Apertus bridge tests, provider harness (all checks), checkpointing 203 passed, XIELU TP2, Core optimizer restore + MLA import guard 7 passed, MLA correctness under `torchrun` 4 ranks 85 passed / 3 skipped per rank |
